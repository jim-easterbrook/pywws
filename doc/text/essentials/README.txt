...
* USB library:
  ...
  * option 1 (best for small systems such as routers):
       ...
       * libusb (http://www.libusb.org/) version 0.1.12 (note: libusb
         1 is not supported)
  ...
  * option 2 (best for Linux PCs and Macs):
       ...
       * hidapi (https://github.com/signal11/hidapi) (note: hidapi on
         Linux can use libusb version 1.0)
...
* For Twitter updates:
  ...
  * simplejson (http://pypi.python.org/pypi/simplejson) (note:
    simplejson is included in Python 2.6 or higher)
...
* EWtoPy.py                  -- converts EasyWeather.dat to DataStore
  format
...
Getting started:
   See doc/guides/getstarted: *How to get started with pywws*.
